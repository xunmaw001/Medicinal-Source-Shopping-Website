...
public class DiscussbaojianpintuijianController {
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<DiscussbaojianpintuijianEntity> wrapper = new EntityWrapper<DiscussbaojianpintuijianEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = discussbaojianpintuijianService.selectCount(wrapper);
